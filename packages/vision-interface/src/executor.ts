...
export const DEFAULT_SUMMARIZE_INSTRUCTION =
  ...
  "用平实直白的连贯文字呈现，像工作摘要一样陈述事实，不要文学化修辞、氛围渲染或抒情，不要逐张罗列每张图的细节。" +
  ...
  "不推断、不编造：观察不到的不虚构；不确定的明确标注不确定；" +
  "除非画面存在可直接读取的文字或钟表证据，输出中不得出现时间、季节、天气、地点等环境词汇" +
  "（如：夏日、白天、清晨、都市、街道名）；" +
  "不得推断人物气质、情绪或态度（如自信、随性、青春）——只描述可观察的动作、姿态与表情；" +
...
export const DEFAULT_DEEP_SUMMARIZE_INSTRUCTION =
  ...
  "细节差异、整体印象。用平实直白的连贯文字呈现，像工作摘要一样陈述事实，不要文学化修辞、氛围渲染或抒情；" +
